/**
 * Iconos del panel web (copiados literal de gonper/src/app/panel/_components/icons.tsx,
 * sin los tipos TS) para que la app se vea EXACTAMENTE igual: mismo trazo (1.5),
 * mismos remates. No usar lucide en el shell/pantallas re-maquetadas: cambia el
 * grosor y se nota.
 */
export const Icon = {
  Home: (p) => (
  ...
  Wallet: (p) => (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" {...p}>
      <path d="M3 7a2 2 0 0 1 2-2h12a2 2 0 0 1 2 2v0H5a2 2 0 0 0-2 2" />
